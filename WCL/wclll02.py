...
# SECURITY: loaded from environment variables instead of being hardcoded.
# Before running, set these in your terminal / Colab cell, e.g.:
...
def calculate_rsi(close_series, period=14):
    """Calculate RSI using proper Wilder's method (SMA seed + smoothing) — matches TradingView/Zerodha/Dhan convention"""
...
# SECURITY: loaded from environment variable instead of being hardcoded.
...
def fetch_and_check_conditions_improved():
    ...
    trading_days_back = 0
    while trading_days_back < 15:  # ~15 trading days of buffer for RSI to stabilize
